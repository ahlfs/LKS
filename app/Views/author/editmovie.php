...
<div class="container">
    <div class="card mt-5">
        ...
        <div class="card-body">
            ...
            <form method="post" action="/updatemovie/<?= $datamovie['id_movie'] ?>" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Title</label>
                    <input type="text" class="form-control" name="title" id="exampleInputEmail1" aria-describedby="emailHelp" autocomplete="none" value="<?= $datamovie['title'] ?>">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="synopsis" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" autocomplete="none"><?= $datamovie['synopsis'] ?></textarea>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-select-lg mb-3" name="genre" aria-label="Large select example">
                        <option value="N/A" disabled>Select Genre</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="year" class="form-control" id="exampleInputPassword1" min="1900" max="2099" step="1" value="<?= $datamovie['release_year'] ?>" />
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="runtime" class="form-control" id="exampleInputPassword1" value="<?= $datamovie['runtime'] ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="cast" class="form-control" id="exampleInputPassword1" value="<?= $datamovie['cast'] ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="age" class="form-control" min="1" max="21" id="exampleInputPassword1" value="<?= $datamovie['age'] ?>">
